<form name="ctForm">
    First Name &nbsp&nbsp <input type="text" name="fn" ng-model="oContact.firstName"
    ...
    <br>
    Last Name &nbsp&nbsp <input type="text" name="ln" ng-model="oContact.lastName" ng-class="{err: ctForm.ln.$invalid}"
    ...
    <br>
    Telephone &nbsp&nbsp&nbsp <input type="tel" name="tel" ng-model="oContact.telephone"
